...
genrootfs() {
echo "
deb [trusted=yes] http://ftp.kr.debian.org/debian/ testing main contrib non-free non-free-firmware
deb [trusted=yes] http://ftp.kr.debian.org/debian/ testing-updates main contrib non-free non-free-firmware
deb [trusted=yes] http://ftp.kr.debian.org/debian/ testing-backports main contrib non-free non-free-firmware
deb [trusted=yes] http://ftp.kr.debian.org/debian-security/ testing-security main contrib non-free non-free-firmware
