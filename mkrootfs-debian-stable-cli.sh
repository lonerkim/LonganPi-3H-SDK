...
genrootfs() {
echo "
deb [trusted=yes] http://ftp.kr.debian.org/debian/ stable main contrib non-free non-free-firmware
deb [trusted=yes] http://ftp.kr.debian.org/debian/ stable-updates main contrib non-free non-free-firmware
deb [trusted=yes] http://ftp.kr.debian.org/debian/ stable-backports main contrib non-free non-free-firmware
deb [trusted=yes] http://ftp.kr.debian.org/debian-security/ stable-security main contrib non-free non-free-firmware
